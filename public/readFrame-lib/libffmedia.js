...
var wasmBinaryFile;
wasmBinaryFile = "libffmedia.wasm";
...
var asmLibraryArg = {
  ...
  H: ___syscall_getdents64,
  F: ___syscall_getuid32,
  C: ___syscall_ioctl,
...
var _initDecoder = (Module["_initDecoder"] = function () {
  return (_initDecoder = Module["_initDecoder"] = Module["asm"]["N"]).apply(
    null,
    arguments
  );
});
var _startClip = (Module["_startClip"] = function () {
  return (_startClip = Module["_startClip"] = Module["asm"]["O"]).apply(
    null,
    arguments
  );
});
var _releaseDecoder = (Module["_releaseDecoder"] = function () {
  return (_releaseDecoder = Module["_releaseDecoder"] =
    Module["asm"]["P"]).apply(null, arguments);
});
var _stopDecode = (Module["_stopDecode"] = function () {
  return (_stopDecode = Module["_stopDecode"] = Module["asm"]["Q"]).apply(
    null,
    arguments
  );
});
var _initBufferCache = (Module["_initBufferCache"] = function () {
  return (_initBufferCache = Module["_initBufferCache"] =
...
var _sendDecodeData = (Module["_sendDecodeData"] = function () {
  return (_sendDecodeData = Module["_sendDecodeData"] =
    Module["asm"]["T"]).apply(null, arguments);
});
var _openDecoder = (Module["_openDecoder"] = function () {
  return (_openDecoder = Module["_openDecoder"] = Module["asm"]["U"]).apply(
    null,
    arguments
  );
});
var _startDecode = (Module["_startDecode"] = function () {
  return (_startDecode = Module["_startDecode"] = Module["asm"]["V"]).apply(
    null,
    arguments
  );
});
var _closeDecoder = (Module["_closeDecoder"] = function () {
  return (_closeDecoder = Module["_closeDecoder"] = Module["asm"]["W"]).apply(
    null,
    arguments
  );
});
var _initFFDecoder = (Module["_initFFDecoder"] = function () {
  return (_initFFDecoder = Module["_initFFDecoder"] = Module["asm"]["X"]).apply(
    null,
    arguments
  );
});
...
var __get_daylight = (Module["__get_daylight"] = function () {
  return (__get_daylight = Module["__get_daylight"] = Module["asm"]["_"]).apply(
    null,
    arguments
  );
});
var __get_timezone = (Module["__get_timezone"] = function () {
  return (__get_timezone = Module["__get_timezone"] = Module["asm"]["$"]).apply(
    null,
    arguments
  );
});
var _memalign = (Module["_memalign"] = function () {
  return (_memalign = Module["_memalign"] = Module["asm"]["aa"]).apply(
    null,
    arguments
  );
});
